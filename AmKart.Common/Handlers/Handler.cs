...
namespace AmKart.Common.Handlers
{
	public class Handler : IHandler
	{
        ...
        private Func<DistributedEStoreException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<DistributedEStoreException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (DistributedEStoreException customException)
            {
                isFailure = true;
